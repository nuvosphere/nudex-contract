...
contract AssetManager {
    ...
    event AssetListed(bytes32 indexed assetId, string name, AssetType assetType, address contractAddress, uint256 chainId);
    ...
    function listAsset(string memory name, AssetType assetType, address contractAddress, uint256 chainId) external {
        ...
        emit AssetListed(assetId, name, assetType, contractAddress, chainId);
    }
