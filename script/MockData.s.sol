...
contract MockData is Script {
    ...
    function assetData() public {
        ...
        consolidateTaskParams[0] = ConsolidateTaskParam("fromAddr1", TICKER, CHAIN_ID, 1 ether, "consolidate txHash1");
        consolidateTaskParams[1] = ConsolidateTaskParam("fromAddr2", TICKER, CHAIN_ID, 2.5 ether, "consolidate txHash2");
        consolidateTaskParams[2] = ConsolidateTaskParam("fromAddr3", TICKER, CHAIN_ID, 3.3 ether, "consolidate txHash3");
